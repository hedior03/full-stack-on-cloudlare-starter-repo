    ...
    <Dialog>
      ...
      <DialogContent className="sm:max-w-md">
        <DialogHeader className="text-center space-y-4">
          <DialogTitle className="text-2xl font-bold">Continue with Google</DialogTitle>
          <p className="text-muted-foreground text-sm">Login or signup by continuing with Google</p>
        </DialogHeader>
