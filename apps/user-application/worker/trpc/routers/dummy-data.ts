export const LINKS = [
  {
    ...
    destinations: 6,
    linkClicks: 2,
    last24Hours: [42, 17, 83, 29, 56, 91, 14, 67, 38, 75, 22, 94, 51, 18, 73, 36, 89, 45, 62, 27, 84, 59, 13, 76],
  },
  {
    name: "Apple AirPods",
    linkId: "eFg6e",
    destinations: 4,
    linkClicks: 1,
    last24Hours: [34, 21, 78, 45, 67, 92, 15, 69, 39, 76, 23, 95, 52, 19, 74, 37, 88, 44, 63, 28, 85, 58, 12, 77],
  },
  {
    ...
    destinations: 5,
    linkClicks: 3,
    last24Hours: [28, 14, 79, 35, 58, 83, 17, 71, 42, 80, 27, 96, 53, 20, 75, 39, 91, 47, 64, 29, 86, 61, 15, 78],
  },
];
